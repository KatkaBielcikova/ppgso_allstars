#ifndef PPGSO_Mainfish_H
#define PPGSO_Mainfish_H
 ...
 */
class Mainfish final : public Object {
private:
...
public:
    /*!
     * Create new Mainfish background
     */
    Mainfish();

    /*!
     * Update Mainfish background
    ...
    /*!
     * Render Mainfish background
     * @param scene Scene to render in
     */
    void render(Scene &scene) override;
};

#endif //PPGSO_Mainfish_H
